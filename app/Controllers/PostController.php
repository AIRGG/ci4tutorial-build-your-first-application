...
class PostController extends BaseController
{
    ...
    public function add() {
        ...
        if (!$validation->withRequest($this->request)->run()) {
            ...
            $file->move(WRITEPATH . 'uploads/avatar', $fileName);
        ...
        if ($posts) {
            foreach ($posts as $post) {
                ...
                <div class="card shadow-sm">
                  <a href="#" id="' . $post['id'] . '" data-bs-toggle="modal" data-bs-target="#detail_post_modal" class="post_detail_btn"><img src="/images/posts/' . $post['image'] . '" class="img-fluid card-img-top"></a>
                  <div class="card-body">
    ...
    public function update() {
        ...
        if ($fileName != '') {
            ...
            if ($this->request->getPost('old_image') != '') {
                unlink(WRITEPATH . 'uploads/avatar/' . $this->request->getPost('old_image'));
            }
        } else {
    ...
    public function delete($id = null) {
        ...
        $post = $postModel->find($id);
        $postModel->delete($id);
        unlink(WRITEPATH . 'uploads/avatar/' . $post['image']);
        return $this->response->setJSON([
            'error' => false,
